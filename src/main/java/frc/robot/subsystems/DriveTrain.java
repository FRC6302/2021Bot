...
/*
  ...
  2. If you have an error, someone has probably posted about it on Chief Delphi. Google the error and
  see what pops up. It could also be a mechanical problem, especially if Pauley built it. 
...
public class DriveTrain extends SubsystemBase {
  ...
  */
  ...
  //TODO: find whereever i used an instant command and change it to a lambda. Also, graph pidController.getSetpoint() to test turn right command
